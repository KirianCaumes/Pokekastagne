...
//     this.post('/api/user/login', async request => {
//         await new Promise(resolve => setTimeout(resolve, 500))
//         return [200, { "Content-Type": "application/json" }, JSON.stringify({ user: { username: 'Demo', password: 'abc', token: 'abc' } })]
//     })
//     this.get('/api/user/me', async request => {
